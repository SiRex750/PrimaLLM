...
def verify_claim(claim: KnowledgeTriple, source_graph: SourceGraph, model_name: str = "cross-encoder/nli-deberta-v3-small", source_sentences: list[str] = None) -> VerificationResult:
    import torch
